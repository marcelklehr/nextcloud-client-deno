 ...
 * 
 * @export
 * @interface ChatMessageWithParent
 */
export interface ChatMessageWithParent {
    /**
     * 
     * @type {string}
     * @memberof ChatMessageWithParent
     */
...
/**
 * Check if a given object implements the ChatMessageWithParent interface.
 */
export function instanceOfChatMessageWithParent(value: object): value is ChatMessageWithParent {
...
export function ChatMessageWithParentFromJSON(json: any): ChatMessageWithParent {
    return ChatMessageWithParentFromJSONTyped(json, false);
}

export function ChatMessageWithParentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChatMessageWithParent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'parent': json['parent'] == null ? undefined : ChatMessageFromJSON(json['parent']),
    };
}

export function ChatMessageWithParentToJSON(value?: ChatMessageWithParent | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'silent': value['silent'],
        'parent': ChatMessageToJSON(value['parent']),
    };
}
